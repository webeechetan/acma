    ...
    <section id="innerpage payment-page" class="greybg">
      ...
      <style>
        ...
        <div id="innerpage" class="whitebg back-btn buttons p-3">
          <div class="whitebgleft"><h2><span>ACMA</span> Technology Summit Awards 2020</h2></div>      
            ...
            <style>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <input type="text" name="event_name"  value="ACMA Technology Summit Awards 2020" required disabled>
                  </div>
              </div>
              <div class="row">
                  <div class="col-sm-4">
              ...
              <div class="row">
                  <div class="col-sm-6">
                      ...
                      <input type="number" readonly class="form-control-plaintext" name="amount" value="2500" required>
                  </div>
                  <div class="col-sm-6">
