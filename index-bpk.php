<?php include("includes/header-new-bpk.php");
				...
				<div class="col-lg-5 text-center mb-3 mb-lg-0 wow fadeInLeft">
					...
					<div class="events_slider">
                        ...
                        <div class="events_slider_items">
							...
							<a href="#"><img src="images/automative-raw.jpg"></a>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<a href="https://www.acma-atpse.in/home.html"><img src="images/jan_popup.png"></a>
					<video width="100%" height="350px" poster="images/poster_img_12-2-21.jpg" controls>
						<source src="video/ACMA_12_02_2021_HighRes.mp4" type="video/mp4">
