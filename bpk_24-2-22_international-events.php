      ...
      <div class="container">
          ...
          <h2>International Events</h2>
           <table cellspacing="0" cellpadding="0" width="80%" class="tablecss">
                <tr>
                    <th width="10%" class="border-right">Date</th>
                    <th width="45%" class="border-right date-blackbg">Programme Description</th>
                    <th width="45%">Venue/Target Audience</th>
                </tr>
                <?php
                $EventsTables=App\Models\EventsTable::where('cat','=',2)->orderBy("id","ASC")->paginate(1000,['*'],'page',(int)$_GET['page']);
