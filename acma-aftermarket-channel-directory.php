          ...
          <div class="row">
            ...
            <div class="col-12 mb-4">
              ...
              <div class="form-check form-check-inline" data-am="category">
                ...
                <input type="text" class="form-control ml-2" onkeyup="checkboxval()">
              </div>
            </div>
          </div>
            ...
            <div class="acknowledgeContent bg-white shadow-sm">
                <div id="acknowledgeContentPrint" class="px-4 bg-white">
                      <div class="row certificate-border">
                        ...
                        <div class="col-12 text-center">
                            ...
                            drive for <span style="font-weight:bold;">ACMA Aftermarket Channel Directory</span> covering the entire Automotive ecosystem.</div>
                            <br>
              ...
              <div class="row my-4 text-center">
                <div style="margin:auto;">
                    <button class="btn btn-success mr-2 mb-2" onclick="printDiv()">Print</button>
