        ...
        <div class="container">
          ...
          <div class="container">
            ...
            <div class="row">
                ...
                <img src="images/Annual-Session-banner-new.png">
        ...
        <div class="container">
    	    ...
    	    <div class="row">
                ...
                <div class="col-12 text-right">
                    ...
                    <div class=""><a href="61st-acma-annual-session.php" class="btn py-2">Back</a></div>
    ...
    box-shadow: inset 1px 2px 8px rgba(0, 0, 0, 0.07);
              ...
              <div class="row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <input type="text" name="event_name"  value="61st ACMA Annual Session" required readonly>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <input type="text" name="gstno" minlength="15" maxlength="15">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <label>Amount for Payment (Inclusive of taxes) <span class="required">*</span> : </label>

                      <input type="number" readonly class="form-control-plaintext" name="amount" value="2950" required>
              ...
              <div class="row">
				...
				<input type="hidden" name="formname" value="indivisual_session_form"/>
