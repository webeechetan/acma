...
<style>
    ...
    box-shadow: inset 1px 2px 8px rgba(0, 0, 0, 0.07);
              ...
              <form name="frm" class="sponsors-form apply_captcha" method="post" action="ccform/ccavRequestHandler.php">
              <div class="row">
                  <div class="col-sm-6">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <input type="text" name="event_name"  value="62nd ACMA Annual Session" readonly required>
                  </div>
              </div>
              <div class="row">
                  <div class="col-sm-6">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <input  id="calculatedamount" type="hidden" value="600000" name="amount" >
                  </div>
