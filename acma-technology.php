    ...
    box-shadow: inset 1px 2px 8px rgba(0, 0, 0, 0.07);
              ...
              <div class="row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <input type="text" name="event_name"  value="ACMA Technology Summit & Awards 2019" required>
                  </div>
              </div>
              <div class="row">
                  <div class="col-sm-6">
                      <label>GST No.<span class="required">*</span> : <span class="required">*</span> : </label>
              ...
              <div class="row">
                  <div class="col-sm-12">
                      <label>Billing Address as per GST : </label>
              ...
              <div class="row">
                  <div class="col-sm-6">
                      ...
                      <select name="amount" style="width:100%;padding:5px; border:solid #ccc 1px;" required>
                          <option>Select Payment</option>
                          <option value="150000">INR 150000 - Associate Sponsors</option>
                          <option value="300000">INR 300000 - Silver Sponsors</option>
                          <option value="600000">INR 600000 - Gold Sponsors</option>
                          <option value="900000">INR 900000 - Diamond Sponsors</option>
                          <option value="1200000">INR 1200000 - Titanium Sponsors</option>
                          <option value="1500000">INR 1500000 - Platinum Sponsors</option>
                          <option value="1800000">INR 1800000 - Principal Sponsors</option>
                      </select>
                  </div>
                  <div class="col-sm-6">
              ...
              <div class="row">
				...
				<input type="hidden" name="formname" value="Acma Technology"/>
