					...
					<div class="header_menu">
						...
						<nav class="menu menu-top">
							...
							<ul>
								...
								<li class="has-submenu"><a href="#">About Us</a><span class="submenu-icon"><i class="fas fa-chevron-down"></i></span>
								...
								<li class="has-submenu"><a href="#">Members</a><span class="submenu-icon"><i class="fas fa-chevron-down"></i></span>
								...
								<li class="has-submenu">
									<a href="#">Events</a><span class="submenu-icon"><i class="fas fa-chevron-down"></i></span>
									...
									<ul>
										...
										<li class="has-submenu">
											...
											<ul>
												<li><a href="east-events.php" onclick="location.href='east-events.php'">Eastern Region</a></li>
												<li><a href="north-events.php" onclick="location.href='north-events.php'">Northern Region</a></li>
												<li><a href="south-events.php" onclick="location.href='south-events.php'">Southern Region</a></li>
												<li><a href="west-events.php" onclick="location.href='west-events.php'">Western Region</a></li>
												<li><a href="YBLF-events.php" onclick="location.href='YBLF-events.php'">YBLF</a></li>
											</ul>
										...
										<li><a href="cluster&projects.php" onclick="location.href='cluster&projects.php'">Cluster And Projects</a></li>
						...
						<div class="menu menu-btm">
							...
							<ul>
								...
								<li class="has-submenu"><a href="#">International Desk</a><span class="submenu-icon"><i class="fas fa-chevron-down"></i></span>
								...
								<li class="has-submenu"><a href="#">Govt. Policy</a><span class="submenu-icon"><i class="fas fa-chevron-down"></i></span>
									...
									<ul>
										...
										<li><a href="state-govt-policy.php" onclick="location.href='state-govt-policy.php'">State Policy/EV Policy</a>
								...
								<li class="has-submenu"><a href="#">Industry Statistics</a><span class="submenu-icon"><i class="fas fa-chevron-down"></i></span>
								...
								<li class="has-submenu"><a href="#">Publications</a><span class="submenu-icon"><i class="fas fa-chevron-down"></i></span>
								...
								<li class="has-submenu"><a href="#">Media Room</a><span class="submenu-icon"><i class="fas fa-chevron-down"></i></span>
								...
								<li class="has-submenu"><a href="#">Gallery</a><span class="submenu-icon"><i class="fas fa-chevron-down"></i></span>
