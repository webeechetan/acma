...
$captcha_code = rand(000000,999999);
...
<body>
  <input type="hidden" name="generated_captcha" class="generated_captcha" value="<?php echo $captcha_code; ?>">
    	...
    	<ul class="clearfix">
          ...
          <li><a href="#">Events</a>
             ...
             <ul>
              ...
              <li><a href="acoe-events.php" onclick="location.href='acoe-events.php'">ACoE</a></li>
          ...
          <li class=" mobileview"><a href="#">International Desk</a>
                  ...
                  <li class=" mobileview"><a href="#">Govt. Policy </a>
                     ...
                     <ul>
                      ...
                      <li><a href="state-govt-policy.php" onclick="location.href='state-govt-policy.php'">State Policy/EV Policy</a></li>
