...
<section id="intro" class="clearfix">
	<div class="introimg">
		...
		<img src="img/impact.jpg" class="img-fluid">
	</div>
</section><!-- #intro -->
<main id="main">
  ...
  ?>
    <section id="innerpage" class="whitebg">
      <div class="container">
        <div class="row">
            <div class="col-sm-12">
            <h3 class="aligncenter cpas">IMPACT December 2021</h3>
            </div></div>
            <div class="row">
                <div class="col-sm-3">
                    <a href="uploads/publication/impact/Impact-Dec-2021.pdf"><img src="uploads/publication/impact/Impact-Dec-2021.jpg" class="img-fluid"></a>
                </div>            
                <div class="col-sm-9">
				...
				<div class="carousel-inner">
                    ...
                    <!-- <div class="item">
						<div class="carousel-col">
						    <a href="uploads/publication/impact/Impact-Feb-2021.pdf">
							<img src="uploads/publication/impact/Impact-Aug-2021.pdf">
							</a>
						</div>
                    </div> -->
					<div class="item active">
						<div class="carousel-col">
						    <a href="uploads/publication/impact/<?php echo$row['attachment']?>">
							<img src="uploads/publication/impact/<?php echo$row['doc_img']?>">
							</a>
						</div>
					</div>
					 <?php $sql="SELECT * FROM publications where doc_title='IMPACT'";
                                  $row=mysqli_query($conn,$sql);
                                 while($result= mysqli_fetch_assoc($row)){?>
						<div class="item">
						<div class="carousel-col">
						    <a href="uploads/publication/impact/<?php echo$result['attachment']?>">
