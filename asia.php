<?php include("includes/header.php");?>
  ...
  <section id="intro" class="clearfix">
    <div class="introimg">
        ...
        <img src="img/asia-bg.jpg" class="img-fluid">
    </div>
  </section><!-- #intro -->
  <main id="main">
          ...
          <div class="row">
              <div class="col-sm-12">
                  <div class="content-txt">
                      <p class="aligncenter">ACMA provides opportunities to its members to explore business opportunities in international markets. <br>
Check out the various initiatives and events in ASIA by ACMA</p>
                  </div>
              </div>
          </div>
          <div class="row">
              ...
              <div class="col-sm-2">
                  ...
                  <ul class="grey-white-bg" id="countryli">
                      <li class="current"><a id="address">SAARC</a></li>
                      <li><a id="address1">ASEAN</a></li>
                      <li><a id="address2">JAPAN/KOREA</a></li>
                      <li><a id="address3">CHINA,TAIWAN,HK</a></li>
                      <li><a id="address4">RUSSIA+CIS</a></li>
                  </ul>
              </div>
              <div class="col-sm-8">
                  ...
                  <div class="content-txt location-page address1" style="display:none">
                      <p>Name of contact person: Ms. Seema Babal, Deputy Director</p>
                      <p>Email id: seema.babal@acma.in</p>
                      <p>Contact Number: +91-11-26160315 Ext.251</p>
                  </div>
                  ...
                  <div class="content-txt location-page address3" style="display:none">
                      <p>Name of contact person: Ms. Monika Handa, Senior Director</p>
                      <p>Email id: monika.handa@acma.in</p>
                      <p>Contact Number: +91-11-26160315 Ext.221</p>
                  </div>
                  <div class="content-txt location-page address4" style="display:none">
                      <p>Name of contact person: </p>
                      <p>Email id: </p>
                      <p>Contact Number: </p>
                  </div>
