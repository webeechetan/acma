...
<?php $sql="SELECT *FROM publications WHERE doc_title='Reaserch-Studies' ORDER BY date DESC";
	...
	<div class="container">
		<div class="row">
			<div class="col-12 text-center">
				<h2 class="banner-title text-white text-uppercase">research studies</h2>
			</div>
		</div>
	</div>
</section>
...
"><img src="uploads/publication/research-studies/<?php echo$row['doc_img']?>"  class="img-fluid"></a>
			</div>
			<div class="col-md-9">
				...
				<div class="multi-slider-sec bg-light_blue p-4">
                    ...
                    <?php $sql="SELECT * FROM publications where doc_title='Reaserch-Studies' ORDER BY date DESC";
                            ...
                            <div class="multi-slider-item">
                                <a href="uploads/publication/research-studies/<?php echo$result['attachment']?>" target="_blank">
