	...
	<div class="container">
		<div class="row">
			<div class="col-12 text-center">
				<h2 class="banner-title text-white text-uppercase">WESTERN REGION EVENTS</h2>
			</div>
		</div>
	</div>
</section>
    ...
    <div class="container">
        <div class="row">
           <div class="col-md-12 mb-4">
				<h3 class="text-center title-big text-center"><b>WESTERN REGION EVENTS</b></h3>	
			</div>
            <div class="col-12">
               <div class="table-res text-right text-md-center">
                   <ul class="table-res_head bg-primary text-white d-none d-md-flex">
                    ...
                    <?php
                $EventsTables=App\Models\EventsTable::where('cat','=',7)->orderBy("id","ASC")->paginate(1000,['*'],'page',(int)$_GET['page']);
