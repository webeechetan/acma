...
?>
  ...
  <section id="intro" class="clearfix">
      ...
      <div class="introimg">
        ...
        <img src="img/annual-report.jpg" class="img-fluid">
    ...
    <section id="innerpage" class="whitebg">
      ...
      <div class="container">
          ...
          <div class="col-sm-3">
              ...
              <a href="uploads/publication/annual-report/<?php echo$row['attachment']?>

"><img src="uploads/publication/annual-report/<?php echo$row['doc_img']?>"  class="img-fluid"></a>
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						...
						<div class="carousel-col">
							...
							<img src="uploads/publication/annual-report/<?php echo$row['doc_img']?>">
					 ...
					 <?php $sql="SELECT * FROM publications where doc_title='Annual-Report' ORDER BY id DESC";
						...
						<div class="carousel-col">
						    ...
						    <a href="uploads/publication/annual-report/<?php echo$result['attachment']?>">
