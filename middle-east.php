<?php include("includes/header.php");?>
  ...
  <section id="intro" class="clearfix">
    <div class="introimg">
        ...
        <img src="img/middleeast.jpg" class="img-fluid">
    </div>
  </section><!-- #intro -->
  <main id="main">
          ...
          <div class="row">
              <div class="col-sm-12">
                  <div class="content-txt">
                      <p class="aligncenter">ACMA provides opportunities to its members  to explore business opportunities in international markets. <br>Check out the various initiatives and events in ASIA by ACMA</p>
                  </div>
              </div>
          </div>
          <div class="row">
              ...
              <div class="col-sm-2">
                  ...
                  <ul class="grey-white-bg" id="countryli">
                      <li class="current"><a id="address">Middle East / Iran/Saudi Arabia
</a></li>
                  </ul>
              </div>
              <div class="col-sm-8">
