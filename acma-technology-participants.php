...
<style>
    ...
    box-shadow: inset 1px 2px 8px rgba(0, 0, 0, 0.07);
              ...
              <div class="row">
                  <div class="col-sm-6">
                      ...
                      <select name="amount" style="width:100%;padding:5px; border:solid #ccc 1px;" required>
                          ...
                          <option value="5900">INR 5900  -  ACMA Members + ACT / ACMA- UNIDO Cluster companies (Past & Present) -  Inclusive of GST</option>
                          <option value="7080">INR 7080 - ACMA Non-Members companies /Individual -  Inclusive of GST</option>
                          <option value="1180">INR 1180 - Academia -  Inclusive of GST</option>
                      </select>
                  </div>
                  <div class="col-sm-6">
              ...
              <div class="row">
				...
				<input type="hidden" name="formname" value="Acma Technology Participants"/>
