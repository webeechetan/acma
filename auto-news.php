...
<?php 
	$sql="SELECT *FROM publications WHERE doc_title='Auto-News' ORDER BY date DESC";
	...
	<div class="container">
		<div class="row">
			<div class="col-12 text-center">
				<h2 class="banner-title text-white text-uppercase">Auto-news</h2>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row text-center text-md-left">
			...
			<div class="col-md-3 mb-4 mb-md-0">
            	<a href="uploads/publication/auto-news/<?php echo$row['attachment']?>">
					<img src="uploads/publication/auto-news/<?php echo$row['doc_img']?>"  class="img-fluid">
				</a>
			</div>
			<div class="col-md-9">
				...
				<div class="multi-slider-sec bg-light_blue p-4">
                    ...
                    <?php 
						...
						<div class="multi-slider-item">
							<a href="uploads/publication/auto-news/<?php echo$result['attachment']?>" target="_blank">
